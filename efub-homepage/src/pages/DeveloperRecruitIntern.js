...
const DeveloperRecruitIntern = () =>{
    return(
        <div>
            <Banner>
                <h1 style = {{height: '3.5rem', marginBottom: '0.01rem'}} >INTERN DEVELOPER</h1>
            ...
            <Main>
                ...
                <Text1 style= {{marginBottom: "0rem"}}>4. 다음중 면접이 '불가능한' 시간을 선택해주세요. </Text1>
                <Text2>불가능한 시간을 모두 선택해주시고, 모두 가능하다면 '모두 가능합니다'를 선택해주세요. </Text2>
                <Foot>
                    <Text2>3/3 페이지</Text2>  
                  <FootSub>
